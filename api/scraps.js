// Cross-device news scrap sync, keyed by a random "sync code" the user
// generates client-side and enters on each device (no login) — same
// mechanism as the fiat/economics project's api/notes.js.
...
export default async function handler(req, res) {
  ...
  try {
    if (req.method === "GET") {
      ...
      const raw = await redisGet(`scraps:${code}`);
